    ...
    if (state.babyname.trim() === "") {
      ...
      if (response.status === "SUCCESS") {
        ...
        if (response.code != apiConfigs.USER_UNSUBSCRIBE) {
          ...
          await StorageService.saveItem(
            "child_id",
            response.data.child.child_id
          );
          if (state.motherhood_status == 1) {
            navigation.navigate("MoreAboutYourChildScreen", {
              child_id: response.data.child.child_id,
              bdate: state.babyborndate,
            });
          } else {
        ...
        {state.isbabyborn == "" ? (
          <View>
            ...
            >
              ...
              >
                <TouchableWithoutFeedback
                  onPress={() => Action_updateMomProfile("Yes")}
                >
                  <View
                    style={{
                      ...
                      borderWidth: state.isbabyborn === "Yes" ? 1 : 0,
              ...
              >
                <TouchableWithoutFeedback
                  onPress={() => Action_updateMomProfile("No")}
                >
                  <View
                    style={{
                      backgroundColor: colors.Darkpink,
                      ...
                      alignItems: "center",
                      justifyContent: "center",
                      borderWidth: state.isbabyborn === "No" ? 1 : 0,
                      borderColor: colors.Blue,
                    }}
                  >
                    <View
            ...
            >
              <View>
                <TextField
                  ...
                  value={
                    state.babyduedate != ""
                      ? moment(state.babyduedate).format("MM/DD/YYYY")
                      : ""
                  }
                  placeholder={
                    state.motherhood_status == 1
                  ...
                  isShowImg={true}
                  onChangeText={(text) =>
                    handleChangeOfText("babyduedate", text)
                  }
                  blurOnSubmit={false}
                  lable={"Baby Due Date"}
                  editable={false}
                ...
                >
                  <View>
                    <TextField
                      ...
                      value={
                        state.babyborndate != ""
                          ? moment(state.babyborndate).format("MM/DD/YYYY")
                          : ""
                      }
                      ...
                      isShowImg={true}
                      onChangeText={(text) =>
                        handleChangeOfText("babyborndate", text)
                      }
                      blurOnSubmit={false}
                ...
                <View style={{ flexDirection: "row", width: deviceWidth - 50 }}>
                  ...
                  <View style={{ marginStart: 50, flexDirection: "row" }}>
                    <TextField
                      ...
                      lable={" "}
                      onChangeText={(text) =>
                        handleChangeOfText("ounces", text)
                      }
                      blurOnSubmit={true}
                      keyboardType={"decimal-pad"}
                      autoCapitalize={"none"}
                    ...
                    <Text
                      style={{
                        ...
                        fontFamily: fonts.rubikRegular,
                        position: "absolute",
                        right: Platform.OS == "android" ? -70 : -60,
                        bottom: 30,
                      }}
                    >
                      {"ounces"}
                ...
                >
                  <View style={{ flexDirection: "row" }}>
                    <TextField
                      ...
                      isShowImg={false}
                      onChangeText={(text) =>
                        handleChangeOfText("inches", text)
                      }
                      blurOnSubmit={true}
                      lable={"Height (in)"}
                      keyboardType={"decimal-pad"}
      ...
      <View style={styles.container}>
        <View>
          ...
          <Text style={styles.subtitleStyle}>
            {
              "Add your baby’s details so that you can accurately track their feeding and activities"
            }
          </Text>
        </View>
        <View style={{ flex: 1 }}>
