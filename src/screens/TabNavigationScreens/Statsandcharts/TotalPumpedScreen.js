  ...
  const graphDataApi = async () => {
    ...
    if (response.status === "SUCCESS") {
        ...
        data.map((item) => {
          const obj =
            item.total_ounces != 0
              ...
              : { value: item.total_ounces, label: item.title };
      ...
      if (response.code == apiConfigs.USER_UNSUBSCRIBE) {
        const trackEventparam = { action: "Paywall_TotalPumping_Screen" };
        trackEvent({ event: "Paywall_TotalPumping_Screen", trackEventparam });
      }
    } else {
      setState((oldState) => ({
        ...oldState,
  ...
  return (
    <View style={stylesBackground.container}>
      ...
      <View style={styles.container}>
            ...
            >
              ...
              >
                <BarChart
                  ...
                  yAxisLabelWidth={
                    state.istype == "1" || state.istype == "3" ? 60 : 40
                  }
                  yAxisTextStyle={{
                    color: colors.Blue,
                    fontSize: 10,
                  ...
                  yAxisLabelSuffix={
                    state.istype == "1" || state.istype == "3" ? "oz" : ""
                  }
        ...
        <BottomButton
          text={"See all recent pumping sessions"}
