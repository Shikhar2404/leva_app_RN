    ...
    return (
        <View style={stylesBackground.container}>
            ...
            <View style={styles.container}>
                <View>
                    <Text style={styles.titleStyle} adjustsFontSizeToFit={true} numberOfLines={1}>{state.type == 1 ? 'Add Weight Growth' : state.type == 2 ? 'Add Height Growth' : 'Add Head Size Growth'}</Text>
                </View>
